...
Deprecated — referensi historis capability/module graph. Spesifikasi bahasa aktif: [ADR-014](adr_014_func_declaration.md)–[ADR-016](adr_016_expression_pipeline.md).
