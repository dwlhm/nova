...
func allowedInternalImports() map[string]map[string]bool {
	return map[string]map[string]bool{
		...
		"internal/artifact":    set("internal/build", "internal/capability", "internal/diagnostic", "internal/lexer", "internal/parser", "internal/project", "internal/security", "internal/target", "internal/view"),
		...
		"internal/conformance": set("internal/artifact", "internal/build", "internal/diagnostic", "internal/lexer", "internal/parser", "internal/project", "internal/scheduler", "internal/security", "internal/validator", "internal/view"),
		"internal/dev":         set(),
